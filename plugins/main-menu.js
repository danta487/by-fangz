  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    ...
	    {title: `📑 〉ɞ 『 Kosong 』`, rowId: "p", description: "....."},
...
const listMessage = {
  text: tek,
  footer: '© 𝑭𝒂𝒏𝒏𝒚 𝑩𝑶𝑻𝒁 | ALL RESERVED',
...
*/
	...
	return conn.sendButton(m.chat, bottime, text, `${imgr + 'Menu'}`, [["REFERAL", _p + "ref"], ["SCRIPT", _p + "sc"], ["OWNER", _p + "owner"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "https://instagram.com/fbryaaannn",
                mediaType: "VIDEO",
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By Ryan Dev TEAM',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://instagram.com/fbryaaannn'
                    }
                },
                {
                    urlButton: {
